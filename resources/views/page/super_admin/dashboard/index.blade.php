          ...
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              ...
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                <a class="dropdown-item" href=" {{route('index.user',['level'=>'operator','akses'=>request()->has('access') ? request()->input('access') : null])}} ">Lihat Detail</a>
              </div>
            </div>
          </div>
          <span class="fw-semibold d-block mb-1">Operator</span>
          <h3 class="card-title mb-2">{{$operator}}</h3>
        </div>
      </div>
    </div>
    <div class="col-lg-3 mt-2">
  ...
  <div class="col-lg-3 mt-2">
    <div class="card">
      <div class="card-body">
        <div class="card-title d-flex align-items-start justify-content-between">
          <div class="avatar flex-shrink-0">
            <i class="bx bx-bed" style="font-size: 0.5in;"></i>
          </div>
          <div class="dropdown">
            <button
            class="btn p-0"
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
            <a class="dropdown-item" href=" {{route('index.kamar',['akses'=>request()->has('access') ? request()->input('access') : null])}} ">Lihat Detail</a>
          </div>
        </div>
      </div>
      <span class="fw-semibold d-block mb-1">Semua Kamar</span>
      <h3 class="card-title mb-2">{{$semua_kamar}}</h3>
    </div>
  </div>
</div>
<div class="col-lg-3 mt-2">
  <div class="card">
    <div class="card-body">
      <div class="card-title d-flex align-items-start justify-content-between">
        <div class="avatar flex-shrink-0">
          <i class="bx bx-cabinet" style="font-size: 0.5in;"></i>
        </div>
        <div class="dropdown">
          <button
          class="btn p-0"
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
          <a class="dropdown-item" href=" {{route('index.fasilitas')}} ">Lihat Detail</a>
        </div>
      </div>
    </div>
    <span class="fw-semibold d-block mb-1">Fasilitas</span>
    <h3 class="card-title mb-2">{{count($fasilitas)}}</h3>
  </div>
</div>
</div>
<div class="col-lg-3 mt-2">
  <div class="card">
    <div class="card-body">
      <div class="card-title d-flex align-items-start justify-content-between">
        <div class="avatar flex-shrink-0">
          <i class="bx bxs-flame" style="font-size: 0.5in;"></i>
        </div>
        <div class="dropdown">
          <button
          class="btn p-0"
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
          <a class="dropdown-item" href=" {{route('index.cabang')}} ">Lihat Detail</a>
        </div>
      </div>
    </div>
    <span class="fw-semibold d-block mb-1">Cabang</span>
    <h3 class="card-title mb-2">{{$cabang}}</h3>
  </div>
</div>
</div>
<div class="col-lg-3 mt-2">
  <div class="card">
    <div class="card-body">
      <div class="card-title d-flex align-items-start justify-content-between">
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
          <a class="dropdown-item" href=" {{route('index.kamar',['keyword'=>'Belum Terpakai'])}} ">Lihat Detail</a>
        </div>
      </div>
    </div>
    <span class="fw-semibold d-block mb-1 {{$warna_text_kamar}}">Kamar Tersedia</span>
    <h3 class="card-title mb-2 {{$warna_text_kamar}}">{{$kamar_tersedia}}</h3>
  </div>
</div>
</div>
  ...
  $(function () {
    ...
    var options = {
      ...
      plugins: {
        title: {
          display: true,
          text: "Grafik Pembayaran Tahun {{date('Y')}}",
          font: {
            size: 18
          },
          padding: {
